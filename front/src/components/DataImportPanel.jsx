  ...
  return (
    <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h2 className="text-xl font-semibold text-slate-900">Import FAQ data</h2>
          <p className="mt-1 text-sm text-slate-500">Upload a file to populate the dashboard with real FAQ records.</p>
        </div>
